...
public class MessageDaoImpl implements IMessageDao {
	...
	return qr.query(C3P0Utils.getCurrConnection(),sql, new BeanListHandler<>(Message.class), params);
    }
	...
	Object[] params = { id };
	QueryRunner qr = new QueryRunner();
	return qr.query(C3P0Utils.getCurrConnection(),sql, new BeanHandler<>(Message.class), params);
    }
	...
	public Long queryCount(int receiveid) throws SQLException {
		...
		QueryRunner qr = new QueryRunner();
		return (Long)qr.query(C3P0Utils.getCurrConnection(),sql, new ScalarHandler(), params);
	}
